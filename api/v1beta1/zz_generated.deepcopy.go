...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ArgonautEndpoints) DeepCopyInto(out *ArgonautEndpoints) {
	*out = *in
	in.EndpointsSelector.DeepCopyInto(&out.EndpointsSelector)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ArgonautEndpoints.
func (in *ArgonautEndpoints) DeepCopy() *ArgonautEndpoints {
	if in == nil {
		return nil
	}
	out := new(ArgonautEndpoints)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ArgonautSpec) DeepCopyInto(out *ArgonautSpec) {
	*out = *in
	...
	if in.Ingress != nil {
		...
		*out = make([]ArgonautEndpoints, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
